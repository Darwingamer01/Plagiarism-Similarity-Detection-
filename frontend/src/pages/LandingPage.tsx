        ...
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/20">
            ...
            <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                ...
                >
                    ...
                    {/* Dashboard Preview Image using generate_image placeholder or similar logic if I had an image. For now, using a nice visual placeholder with CSS/SVG */}
                    <motion.div
                        variants={fadeInUp}
                        className="mt-20 mx-auto max-w-5xl rounded-xl border border-border/50 bg-card/50 backdrop-blur shadow-2xl overflow-hidden relative group"
                    >
                        <img
