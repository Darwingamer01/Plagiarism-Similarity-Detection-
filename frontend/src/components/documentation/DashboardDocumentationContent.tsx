...
import { Zap, Lock, Mail, Send, HelpCircle, MessageSquare, Book, Code, Terminal, FileText } from 'lucide-react'
                                        ...
                                        <CardContent className="p-6 flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-col gap-1 text-sm">
                                                    <a href="mailto:support@plagiarismdetector.com" className="text-primary font-medium hover:underline">support@plagiarismdetector.com</a>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
